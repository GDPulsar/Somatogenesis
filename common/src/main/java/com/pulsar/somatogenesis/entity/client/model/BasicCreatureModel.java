...
public class BasicCreatureModel extends EntityModel<BasicCreatureEntity> {
	...
	public BasicCreatureModel(ModelPart root) {
	...
	@Override
	public void setupAnim(BasicCreatureEntity entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
