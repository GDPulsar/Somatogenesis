...
public abstract class SimpleBloodCuriosItem extends Item implements BloodContainer, ICurioItem {
    private final int maxBlood;

    public SimpleBloodCuriosItem(Item.Properties properties, int maxBlood) {
        super(properties);
