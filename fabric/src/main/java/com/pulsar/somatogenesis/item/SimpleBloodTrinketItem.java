...
public abstract class SimpleBloodTrinketItem extends TrinketItem implements BloodContainer {
    private final int maxBlood;

    public SimpleBloodTrinketItem(Properties properties, int maxBlood) {
        super(properties);
